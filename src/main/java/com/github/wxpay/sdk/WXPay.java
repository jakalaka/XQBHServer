...
public class WXPay {
     ...
     * @throws Exception
     */
    public Map<String, String> fillRequestData(Map<String, String> reqData,boolean getkey) throws Exception {
        ...
        if (SignType.MD5.equals(this.signType)) {
            ...
            if(getkey)
            {
                Map<String, String> getkeyRequire=new HashMap<String, String>();
                getkeyRequire.put("mch_id",config.getMchID());
                getkeyRequire.put("nonce_str", WXPayUtil.generateNonceStr());
                getkeyRequire.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
                System.out.println(this.checkresp+"xxxx");
                Map<String, String> getkeyResponse=getsignKey(getkeyRequire, Com.wxpayConnectTimeout,Com.wxpayReadTimeout);
                key=getkeyResponse.get("sandbox_signkey");
                config.setKey(key);
            }
        }
    ...
    public Map<String, String> processResponseXml(String xmlStr) throws Exception {
        ...
        if (return_code.equals(WXPayConstants.FAIL)) {
            ...
            System.out.println("??????????"+this.checkresp);
           if (!this.checkresp || this.isResponseSignatureValid(respData) ) {
               return respData;
           }
           else {
    ...
    public Map<String, String> microPay(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData,true), connectTimeoutMs, readTimeoutMs);
    ...
    public Map<String, String> getsignKey(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData,false), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
    ...
    public Map<String, String> reverse(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData,true), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
    ...
    public Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respStr = this.requestWithoutCert(url, this.fillRequestData(reqData,true), connectTimeoutMs, readTimeoutMs).trim();
