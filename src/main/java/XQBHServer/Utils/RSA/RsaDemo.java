...
public class RsaDemo {
	...
	public static void main(String[] args) {
		...
		// 组装数据
//		encode("{\"head\":{\"HTJYM_\":\"ZDLogin\",\"QTRQ_U\":\"20180301\",\"ZDBH_U\":\"ZD0000000001\",\"IP_UUU\":\"192057t6r9.iask.in:26617\",\"QTLS_U\":\"CZD00000000010000003\",\"ZDJYM_\":\"1234567890\",\"QTSJ_U\":\"233235\",\"QTJYM_\":\"ZDLogin\"},\"body\":{}}");

		String bizParam="{\"head\":{\"HTJYM_\":\"ZDLogin\",\"QTRQ_U\":\"20180302\",\"ZDBH_U\":\"ZD0000000001\",\"IP_UUU\":\"192057t6r9.iask.in:26617\",\"QTLS_U\":\"CZD00000000010000003\",\"ZDJYM_\":\"1234567890\",\"QTSJ_U\":\"223135\",\"QTJYM_\":\"ZDLogin\"},\"body\":{}}";
		String sign=null;

		try {
			sign = RSAUtil.sign(bizParam.getBytes(charset), signPrivateKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void encode(String bizParam) {
		try {
			...
			String bizParamEncrypt = HashUtil
					.encryptBASE64(RSAUtil.encryptByPrivateKey(bizParam.getBytes(charset), encryptPrivateKey));
	...
	public static String decode() {
		...
		try {
			bizParamsJson = new String(
					RSAUtil.decryptByPublicKey(HashUtil.decryptBASE64(bizParams), encryptPublicKey));
		} catch (Exception e) {
			e.printStackTrace();
		}
