...
public class AlipayCancelLoop extends Tran {
    ...
    public boolean exec(TranObj tranObj) throws ParseException {
        ...
        dateLimit.setTime(dateLimit.getTime() - Com.alipayCancelTimeThreshold);//超时时间
        ...
        mdzsjExample.clear();
        mdzsjExample.or().andZFZHLXEqualTo("z").andJYZT_UIn(Arrays.asList("w", "u")).andFRDM_UEqualTo("9999").andHTRQ_UEqualTo(dArrary[0]).andJYSJ_ULessThan(dArrary[1]);
        mdzsjExample.or().andZFZHLXEqualTo("z").andJYZT_UIn(Arrays.asList("w", "u")).andFRDM_UEqualTo("9999").andHTRQ_ULessThan(dArrary[0]);
