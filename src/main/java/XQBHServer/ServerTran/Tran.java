...
//            tranObj.sqlSession.rollback();
    ...
    public static void runERR(TranObj tranObj, String CWDM_U) {
        ...
        tranObj.setHead("CWXX_U",Com.ERRMap.get(CWDM_U));
//        if (null!=tranObj.sqlSession)
//            tranObj.sqlSession.rollback();
        Logger.log(tranObj,"LOG_ERR", "rollback  tranObj.CWDM_U=" + tranObj.getHead("CWDH_U") + "  tranObj.CWXX_U" + tranObj.getHead("CWXX_U") );
    }
}
